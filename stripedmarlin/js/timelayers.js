...
<!-- PSAT Tracks ---!>
	...
	var startTime = new Date('2017-07-19TT12:00:00.000Z'), endTime = new Date('2017-09-29TT12:00:00.000Z'), interval = 'P1D';
	...
	var startTime = new Date('2017-12-04TT12:00:00.000Z'), endTime = new Date('2018-03-11TT12:00:00.000Z'), interval = 'P1D';
	var Time14 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2017-06-19TT12:00:00.000Z'), endTime = new Date('2018-05-31TT12:00:00.000Z'), interval = 'P1D';
	var Time15 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-05-28TT12:00:00.000Z'), endTime = new Date('2018-07-26TT12:00:00.000Z'), interval = 'P1D';
	...
	var startTime = new Date('2018-05-21TT12:00:00.000Z'), endTime = new Date('2018-09-03TT12:00:00.000Z'), interval = 'P1D';
	var Time18 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-06-16TT12:00:00.000Z'), endTime = new Date('2019-02-14TT12:00:00.000Z'), interval = 'P1D';
	var Time19 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-05-23TT12:00:00.000Z'), endTime = new Date('2018-09-02TT12:00:00.000Z'), interval = 'P1D';
	var Time20 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-05-28TT12:00:00.000Z'), endTime = new Date('2018-09-01TT12:00:00.000Z'), interval = 'P1D';
	var Time21 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-12-17TT12:00:00.000Z'), endTime = new Date('2019-02-11TT12:00:00.000Z'), interval = 'P1D';
	var Time22 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2018-12-18TT12:00:00.000Z'), endTime = new Date('2019-04-10TT12:00:00.000Z'), interval = 'P1D';
	var Time23 = L.TimeDimension.Util.explodeTimeRange(startTime, endTime, interval);

	var startTime = new Date('2019-04-09TT12:00:00.000Z'), endTime = new Date('2019-05-04TT12:00:00.000Z'), interval = 'P1D';
